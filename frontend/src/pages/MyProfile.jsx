...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    name: "Komeshan Moorthy",
    image: assets.profile_pic,
    email:'komeshan@gmail.com',
    phone:'+94 75 756 2975',
    address:{
      line1:'5th Lane, wellawatte',
      line2:'Colombo - 06'
    },
    gender:'Male',
    dob:'1998-05-15'
  ...
  return (
    <div className='max-w-lg flex-col gap-2 text-sm'>
      ...
      {
        isEdit
        ? <input className='bg-gray-100 text-3xl font-medium max-w-72 mt-4' type="text" value={userData.name} onChange={(e) => setUserData(prev => ({...prev, name:e.target.value}))}/>
